...
class KRAckAttackFt():
	...
	def run(self):
		...
		os.system('wpa_supplicant -B -Dnl80211 -i %s -c %s' % (self.nic_iface, self.file_name))
...
class krack_code(app_manager.RyuApp):
    #if __name__ == "__main__":
    def __init__(self, *args, **kwargs):
        super(krack_code, self).__init__(*args, **kwargs)
